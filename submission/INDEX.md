...
| 9 | **Screenshots** | Designer, Renderer/answer view, AI review, export, billing | shot list in [`./demo/SCRIPT.md`](./demo/SCRIPT.md) → `./screenshots/` | 📸 Capture list READY (8 frames); capture is human-only |
