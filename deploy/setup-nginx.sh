...
server {
    ...
    location / {
        ...
        # Supabase SSR auth can set several large Set-Cookie headers during
        # OAuth callback. nginx's default proxy header buffer is too small and
        # returns 502 "upstream sent too big header".
