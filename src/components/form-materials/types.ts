 ...
 * Runtime renderers + property panels are typed but optional;
...
export interface RuntimeRendererProps {
  ...
  /**
   * Runtime upload context for file/image widgets. Kept optional so the
   * same Renderer can be used in read-only review surfaces.
   */
