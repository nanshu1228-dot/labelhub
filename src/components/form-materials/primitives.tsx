...
export function TextRow({
  ...
  // Re-sync if parent swaps the field (selection change). Deliberate
  // prop→state resync of a commit-on-blur mirror, not a cascading update.
  useEffect(() => {
...
export function NumberRow({
  ...
  // Deliberate prop→state resync of a commit-on-blur mirror.
  useEffect(() => {
    // eslint-disable-next-line react-hooks/set-state-in-effect
