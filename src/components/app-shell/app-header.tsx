 ...
 *   - "Queue"  → /my/queue   — shown to any user with any role
    ...
    >
      <div className="mx-auto max-w-[1280px] flex items-center gap-3 px-4 sm:px-6">
        ...
        <nav
          ...
          aria-label="Primary"
        >
          {canQueue ? <HeaderPill href="/my/queue" label="Queue" /> : null}
        ...
        <div className="ml-auto flex items-center gap-2">
          ...
          {user ? (
            <details className="md:hidden relative">
              ...
              >
                {canQueue ? <DrawerLink href="/my/queue" label="Queue" /> : null}
  ...
  return (
    <details className="relative">
      ...
      >
        ...
        <DrawerLink href="/my/queue" label="My queue" />
