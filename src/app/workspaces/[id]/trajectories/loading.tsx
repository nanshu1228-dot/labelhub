/**
 * Route-level loading UI for /workspaces/[id]/trajectories.
 *
 * Server component (no hooks, no "use client"). Next.js renders this as the
 * Suspense fallback while the trajectories page streams. It mirrors that
 * page's shell: an .app-light wrapper, a sticky header strip, and a
 * max-w-[1200px] content column with shimmer placeholder cards.
 *
