/**
 * Route-level loading UI for /my/queue.
 *
 * Server component (no hooks, no "use client"). Suspense fallback shown while
 * the annotator queue page streams. The page renders its own .app-light shell
 * (the /my layout does not add it), so this matches that: an .app-light
 * min-h-screen main with a max-w-[960px] column, a header strip, and shimmer
 * placeholder cards.
 *
