 ...
 *
 * Loads a saved schema and seeds the Designer canvas. Owner edits are
 * saved as a new append-only version; tasks already pinned to this row
 * keep rendering their frozen schema.
 *
